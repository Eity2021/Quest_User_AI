      ...
      <form className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            type="text"
            placeholder="Name"
            className="bg-[#2A3545]/80 border-[#3A4555] text-white placeholder:text-white/40 h-12 rounded-xl focus:border-accent focus:ring-accent"
          />
        </div>
        ...
        <Button
          type="submit"
          className="w-full h-14 text-base font-medium bg-transparent border-2 border-accent text-white hover:bg-accent/10 rounded-xl transition-colors mt-6"
        >
          Sign up
        </Button>
      </form>
